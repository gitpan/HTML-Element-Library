# This Makefile is for the HTML::Element::Library extension to perl.
#
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/HTML/Element/Library.pm
...
TO_INST_PM = lib/HTML/Element/Library.pm \
	lib/HTML/Element/Library.pm.foy

PM_TO_BLIB = lib/HTML/Element/Library.pm \
	blib/lib/HTML/Element/Library.pm \
	lib/HTML/Element/Library.pm.foy \
	blib/lib/HTML/Element/Library.pm.foy
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3pm --perm_rw=$(PERM_RW)\
	  lib/HTML/Element/Library.pm $(INST_MAN3DIR)/HTML::Element::Library.$(MAN3EXT) 
...
realclean purge ::  clean realclean_subdirs
	...
	$(RM_RF) $(DISTVNAME)
	$(RM_F)  blib/lib/HTML/Element/Library.pm.foy blib/lib/HTML/Element/Library.pm $(MAKEFILE_OLD) $(FIRST_MAKEFILE)
...
metafile :
	...
	$(NOECHO) $(ECHO) '    File::Slurp:                   9999.06' >> META.yml
...
ppd:
	...
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="File-Slurp" VERSION="9999,06,0,0" />' >> $(DISTNAME).ppd
...
pm_to_blib: $(TO_INST_PM)
	$(NOECHO) $(PERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')'\
	  lib/HTML/Element/Library.pm blib/lib/HTML/Element/Library.pm \
	  lib/HTML/Element/Library.pm.foy blib/lib/HTML/Element/Library.pm.foy 
	$(NOECHO) $(TOUCH) $@
